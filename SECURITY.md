...
[private vulnerability reporting](https://github.com/ESA-Blueshell/brevo-client/security/advisories/new)
...
- **Credential handling.** The clients take a bot token and send it as an
  `Authorization` header. Nothing is logged, cached or persisted. `createBrevoClient`
...
Vulnerabilities in the Brevo API itself belong
[upstream](https://github.com/brevo/brevo-openapi/issues).
